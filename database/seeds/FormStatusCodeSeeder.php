...
class FormStatusCodeSeeder extends Seeder
{
    private $formStatusCodes = [ 
    	["store_status" =>	'submitted', 'admin_status' => 'new', 'icon'=>'fa-paper-plane', 'colour' => 'green-bg'], 
    	...
    	["store_status" =>	'not approved', 'admin_status' => 'not approved', 'icon'=>'fa-thumbs-o-down', 'colour' => 'green-bg'], 
    	["store_status" =>	'closed', 'admin_status' => 'closed', 'icon'=>'fa-times-circle', 'colour' => 'green-bg']
