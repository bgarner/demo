            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="urgetnNoticeNav">
                    <a style="color: white" href="/{{ Request::segment(1) }}/urgentnotice"><i class="fa fa-bolt"></i> <span class="nav-label">{{__("URGENT NOTICE")}}</span>
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}"><i class="fa fa-home"></i> <span class="nav-label">{{__("Dashboard")}}</span></a>
                </li>
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}/calendar"><i class="fa fa-calendar"></i> <span class="nav-label">{{ __("Calendar") }}</span><span class="fa arrow"></span></a>
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}/communication"><i class="fa fa-bullhorn"></i> <span class="nav-label">{{ __("Communications") }}</span>
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}/alerts"><i class="fa fa-bell"></i> <span class="nav-label">{{__("Alerts")}}</span>
                    @if( isset($alertCount) )
                        @if( $alertCount > 0)
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}/document"><i class="fa fa-book"></i> <span class="nav-label">{{__("Library")}}</span></a>
                </li>
                ...
                <li>
                @endif
                    <a href="/{{ Request::segment(1) }}/video"><i class="fa fa-video-camera"></i> <span class="nav-label">{{__("Video Library")}}</span></a>
