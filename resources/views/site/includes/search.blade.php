<div class="row" style="border:thin solid #ccc; position:relative; top:2px;">
	<form role="form" class="form-inline" style="width: 100%; padding-left: 10px; " method="get" action="/{{ Request::segment(1) }}/search">
		...
		<div>
	    	...
	    	<span style="width:75%; float:left" class="search-container"> <input type="text" name="q" id="top-search" placeholder="{{__("Search")}} . . . " id="search" style="border: none;font-size: 12px; position:relative; width:75%; top:6px;"></span>

	    	<span style="width:20%" class="submit-container"><button type="submit" class="btn btn-primary btn-sm search-submit" style="display: inline ; border-radius:0px; font-size:12px;float:right; width:20%">{{__("Search")}}</button></span>
	    </div>
