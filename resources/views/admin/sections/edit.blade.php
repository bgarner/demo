...
<body class="fixed-navigation adminview">
	...
	<div id="page-wrapper" class="gray-bg" >
		...
		<div class="wrapper wrapper-content  animated fadeInRight">
		                        ...
		                        <div class="ibox-content">
                                    ...
                                    <form method="get" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                        	...
                                        	<div class="col-sm-10">
                                        		<input type="text" class="form-control" name="section_name" id="section_name" value="{{ $section->section_name }}" />
                                        	</div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4 col-sm-offset-2">
                                                ...
                                                <button class="section-edit btn btn-primary" type="submit"><i class="fa fa-check"></i> Save Section</button>
				...
				<script src="/js/custom/admin/sections/editSection.js"></script>
