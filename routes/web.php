...
Route::post('/getFlyerBoxes', 'Tools\FlyerPageSelectionController@show');
Route::post('/getFlyerBoxData', 'Tools\FlyerBoxSelectionController@show');
Route::get('/{storeno}/tools/productdelivery/{division}', array('uses' => 'Tools\InitialsController@index'));

Route::get('/tools/productdelivery/departments', array('uses' => 'Tools\InitialsController@getDepartments'));
Route::get('/tools/productdelivery/subdepartments', array('uses' => 'Tools\InitialsController@getSubDepartments'));
Route::get('/tools/productdelivery/classes', array('uses' => 'Tools\InitialsController@getClasses'));
Route::get('/tools/productdelivery/brands', array('uses' => 'Tools\InitialsController@getBrands'));
Route::get('/tools/productdelivery/styles', array('uses' => 'Tools\InitialsController@getStyles'));
